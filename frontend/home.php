...
<div class="flex justify-end ">
                <a href="./add-task.php" class="bg-green-400 px-5 py-2 rounded-lg text-black">add task</a>
                    ...
                    <tbody class="divide-y divide-gray-300 ">
                                       ...
                                       <table class=" min-w-full rounded-xl">
                                         <thead>
                                             <tr class="bg-gray-50">
                                                 ...
                                                 <th scope="col" class="p-5 text-left text-sm leading-6 font-semibold text-gray-900 capitalize"> Title </th>
                       ...
                       $data =  $obj->ReadData([] , "`user_id` = {$_SESSION['user'][0]['id']}");
                       $i = 0;
                       foreach ($data as $raw) {
                        $i++;
                        echo <<< eof
                          <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                          <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900">{$i} </td>
                          <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 ">{$raw['title']} </td>
                             <td class="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900"> {$raw['description']}</td>
                             <td class=" p-5 ">
                                 <div class="flex items-center gap-1">
                                     <a href="./edit.php?id={$raw['id']}&&title={$raw['title']}&&description={$raw['description']}" class="p-2  rounded-full  group transition-all duration-500  flex item-center">
                                     ...
                                     <a href="../backend/delete.php?id={$raw['id']}" class="p-2 rounded-full  group transition-all duration-500  flex item-center">
